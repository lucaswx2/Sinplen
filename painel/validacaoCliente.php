...
if (count($_POST)>0) {
    ...
    if (isset($_POST['cpf']) && strlen($_POST['cpf']) > 0 && validarCPF($conn, $_POST['cpf'])) {
    ...
    if (isset($_POST['estados']) && strlen($_POST['estados']) > 0) {
        $dadosCliente['estados'] = $_POST['estados'];
    } else {
        $tem_erro = true;
    ...
    if (!$tem_erro) {
        ...
        $cadastrar =insereClienteBD($dadosCliente['nome'], $dadosCliente['cpf'], $dadosCliente['endereco'],
                $dadosCliente['telefone1'], $dadosCliente['telefone2'], $dadosCliente['rg'],
                $produto, $dadosCliente['estados'], $dadosCliente['cidades'],
                $dadosCliente['cep'], $conn, $dadosCliente['bairro'],$dadosCliente['data_nsc'],$_SESSION['usr_session']);
